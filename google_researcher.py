...
def main():
    ...
    if col1.button('Generate Report') and (query and st.session_state.search_triggered == False):        
        ...
        -- "Executive Summary (less than 3 bullet points of key conclusions that answer user request precisely, be short and cociese, and to the point, use reference url)
